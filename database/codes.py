...
class TypeOfInteractionEvent(CodeBase):
    ...
    lifecycle_status_dict = interaction_events_by_status
    lifecycle_statuses: Mapped[List["LifeCycleStatus"]] = relationship(
        secondary="codes.event_association",
        backref="types_of_interaction_event",
        overlaps=(
            "lifecycle_statuses,types_of_interaction_event,"
            "names_of_plan_case_decision,types_of_processing_event"
        ),
    )
...
class NameOfPlanCaseDecision(CodeBase):
    ...
    lifecycle_status_dict = decisions_by_status
    lifecycle_statuses: Mapped[List["LifeCycleStatus"]] = relationship(
        secondary="codes.event_association",
        backref="names_of_plan_case_decision",
        overlaps=(
            "lifecycle_statuses,types_of_interaction_event,"
            "names_of_plan_case_decision,types_of_processing_event"
        ),
...
class TypeOfProcessingEvent(CodeBase):
    ...
    lifecycle_status_dict = processing_events_by_status
    lifecycle_statuses: Mapped[List["LifeCycleStatus"]] = relationship(
        secondary="codes.event_association",
        backref="types_of_processing_event",
        overlaps=(
            "lifecycle_statuses,types_of_interaction_event,"
            "names_of_plan_case_decision,types_of_processing_event"
        ),
